        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li><a href='<spring:url value="/app/admin/users"/>'><spring:message code="admin.users.gestion"/></a></li>
              <li><a href="<spring:url value="/app/admin/categorie/index"/>"><spring:message code="admin.categorie.gestion"/></a></li>
               <li><a href='<spring:url value="/app/admin/events/index"/>'><spring:message code="admin.events.gestion"/></a></li>
        		</ul>
        		
        		
        		<ul class=" nav navbar-nav pull-right">
        			<li><a href="<spring:url value="/app/admin/stat"/>"><spring:message code="admin.statistique"/></a></li>
    			<li class="dropdown">
