           ...
           <img src="${item.img }" class="img-responsive img-thumbnail" width="100%" height ="100%" />
            ...
            <div class="col-md-8">
               ...
               <p>${item.description }&nbsp;</p>
                <a href=" <spring:url value="/app/admin/events/show/${item.id }"/>"><button class="btn btn-primary"><spring:message code="event.btn.afficher" /> </button></a>
                 <a href=" <spring:url value="/app/admin/events/edit/${item.id }"/>"><button class="btn btn-warning"><spring:message code="admin.action.update" /> </button></a>
                  <a href=" <spring:url value="/app/admin/events/delete/${item.id }"/>"><button class="btn btn-danger"><spring:message code="admin.action.delete" /> </button></a>
